...
public class FoodPanel extends javax.swing.JFrame {
     ...
     */
    static String y, z, x;
    public FoodPanel(String a, String b, String c) {
        initComponents();
        y=a;
        z=b;
        x=c;
    ...
    private void initComponents() {
        ...
        RegFoodPackagesPanel.add(selectRFPAdd, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 410, -1, -1));
        ...
        RegFoodPackagesPanel.add(regFPReset, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 410, -1, -1));
        ...
        RegFoodPackagesPanel.add(regFpackageNolbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 360, -1, -1));
        ...
        RegFoodPackagesPanel.add(jcomRegFPSelecPack, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 350, 150, 30));
        ...
        RegFoodPackagesPanel.add(txtFPNoOfPlates, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 20, 50, 30));
        ...
        RegFoodPackagesPanel.add(regFPBack, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 360, -1, -1));
        ...
        RegFoodPackagesPanel.add(regFPNext, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 360, -1, -1));
        ...
        RegFoodPackagesPanel.add(regFPAddDecor, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 410, -1, -1));
        ...
        RegFoodPackagesPanel.add(regFPAddCusFP, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 410, -1, -1));
        ...
        RegFoodPackagesPanel.add(regFPSetTotalPrice, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 350, -1, -1));
        ...
        RegFoodPackagesPanel.add(regFPAddPay, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 410, -1, -1));
        ...
        RegFoodPackagesPanel.add(regFPEnterCustomerNIClbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 20, 170, 30));
        RegFoodPackagesPanel.add(regFPEnterEventIDlbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 20, 80, 30));
        RegFoodPackagesPanel.add(regFPTotalPricelbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 350, 120, 30));
        ...
        RegFoodPackagesPanel.add(hno, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 20, 90, 30));
        ...
        foodPackagesPanelLayout.setHorizontalGroup(
            ...
            .addGroup(foodPackagesPanelLayout.createSequentialGroup()
                .addComponent(jTabbedPaneFoodPackages, javax.swing.GroupLayout.DEFAULT_SIZE, 854, Short.MAX_VALUE)
                .addContainerGap())
        );
        foodPackagesPanelLayout.setVerticalGroup(
            foodPackagesPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(foodPackagesPanelLayout.createSequentialGroup()
                .addComponent(jTabbedPaneFoodPackages, javax.swing.GroupLayout.PREFERRED_SIZE, 488, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, Short.MAX_VALUE))
        );
    ...
    private void selectRFPAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_selectRFPAddActionPerformed
        ...
        try {
            ...
            if (x == 0) {
                ...
                String sql = "INSERT INTO event_food_packages (fp_event_id,fp_customer_NIC,no_of_plates,fp_regular,fp_price,order_status,fp_menu_id, h_no) VALUES ('" + regFPEventID + "','" + regFPCusNIC + "','" + noOfPlates + "','" + packName + "','" + packPrice + "','" + status + "','" + menuId + "','"+hNo+"')";
...
//               
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FoodPanel(y,z,x).setVisible(true);
            }
        });
    }
